            ...
            <div class="col-12 col-sm-6 col-md-3 mb-3">
                <div class="card shadow-sm border-0 h-100" style="border-radius: 50px;">
                    <div class="card-body text-center"
                        style="background-color:rgb(227, 255, 233); border-radius: 10px;">
                        <p class="card-text text-muted">Permohonan Ditangani</p>
                        <a href="#" class="btn btn-primary btn-sm"></a>
                        <h1 id="countup-processed" data-countup="127"
                            data-json='{"start": 0, "end": 127, "duration": 2}'>127</h1>

                        <p class="card-text text-muted" style="color: #28a745 !important;">Sudah diproses
                            admin</p>
                        <p class="text-success"><span class="text-success fw-normal">↗ 12% dari bulan
                                lalu</span></p>
                    </div>
                </div>
            </div>
            <div class="col-12 col-sm-6 col-md-3 mb-3">
                <div class="card shadow-sm border-0 h-100" style="border-radius: 50px;">
                    <div class="card-body text-center" style="background-color:rgb(255, 239, 188);">
                        ...
                        <a href="#" class="btn btn-primary btn-sm"></a>
                        <h1 id="countup-pending" data-countup="123" data-json='{"start": 0, "end": 123, "duration": 2}'>
                            123</h1>

                        <p class="card-text text-muted" style="color: #28a745 !important;">Menunggu tindak
                            lanjut</p>
                        <p class="text-danger" style="color: red;"><span class="text-danger fw-normal"
                                style="color: red;">↘5% dari bulan lalu</span></p>
                    </div>
                </div>
            </div>
            <div class="col-12 col-sm-6 col-md-3 mb-3">
                <div class="card shadow-sm border-0 h-100" style="border-radius: 50px;">
                    <div class="card-body text-center" style="background-color:rgb(192, 235, 253);">
                        ...
                        <a href="#" class="btn btn-primary btn-sm"></a>
                        <h1 id="countup-active" data-countup="151" data-json='{"start": 0, "end": 151, "duration": 2}'>
                            151</h1>

                        <p class="card-text text-muted" style="color: #28a745 !important;">Sedang menjalani
                            program</p>
                        <p class="text-success"><span class="text-success fw-normal">↗8% dari bulan
                                lalu</span></p>
                    </div>
                </div>
            </div>
            <div class="col-12 col-sm-6 col-md-3 mb-3">
                <div class="card shadow-sm border-0 h-100" style="border-radius: 50px;">
                    <div class="card-body text-center" style="background-color:rgb(227, 255, 233);">
                        ...
                        <a href="#" class="btn btn-primary btn-sm"></a>
                        <h1 id="countup-graduated" data-countup="134"
                            data-json='{"start": 0, "end": 134, "duration": 2}'>134</h1>

                        <p class="card-text text-muted" style="color: #28a745 !important;">Berhasil
                            menyelesaikan</p>
                        <p class="text-success"><span class="text-success fw-normal">↗ 15% dari bulan
                                lalu</span></p>
                    </div>
                </div>
            </div>
                ...
                <div>
                    <div class="card h-100 shadow-sm" style="border-radius: 12px; background-color: #f1f5f9;">
                        <div class="card-body text-center py-4">
                            ...
                            <p class="fw-bold" style="font-size: 1.8rem;">3<span
                                    style="font-weight: normal;">/bulan</span></p>
